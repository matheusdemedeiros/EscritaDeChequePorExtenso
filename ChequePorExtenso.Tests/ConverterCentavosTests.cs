...
namespace ChequePorExtenso.Tests
{
    ...
    public class ConverterCentavosTests
    {
        ...
        public void Deve_Converter_1_Centavo(string valor, string resultadoEsperado)
        {
            ConversorCentavos cv = new ConversorCentavos();

            var resultado = cv.ConverterCentavos(decimal.Parse(valor));
        ...
        public void Deve_Converter_Do_2_Ate_19_Centavo(string valor, string resultadoEsperado)
        {
            ConversorCentavos cv = new ConversorCentavos();
        ...
        public void Deve_Converter_Do_11_Ate_19_Centavo(string valor, string resultadoEsperado)
        {
            ConversorCentavos cv = new ConversorCentavos();
        ...
        public void Deve_Converter_Dezenas_Inteiras_De_Centavo(string valor, string resultadoEsperado)
        {
            ConversorCentavos cv = new ConversorCentavos();
        ...
        public void Deve_Converter_Dezenas_E_Unidades_De_Centavo(string valor, string resultadoEsperado)
        {
            ConversorCentavos cv = new ConversorCentavos();
